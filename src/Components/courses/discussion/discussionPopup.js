...
import { addDiscussionSchema } from "../../../schemas/coursesSchema";
...
function DiscussionPopup({ popUp, onSuccess, editData, isEditMode }) {
  ...
  const onSubmit = (data) => {
    ...
    if (isEditMode) {
      const index = discussions.findIndex((disc) => disc.id === editData.id);
      discussions[index] = { ...data, id: editData.id };
      ...
      <ScrollArea className="h-[600px]">
        <div className="flex justify-between p-4 lg:p-8">
          <p className="text-xl lg:text-3xl font-bold"> 
            {isEditMode ? "Edit Discussion" : "Add Discussion"}
          </p>
        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="flex gap-4 justify-end py-4 w-full lg:w-[850px]">
              ...
              >
                {isEditMode ? "Update Discussion" : "Publish"}
              </Button>
            </div>
          </form>
        </Form>
